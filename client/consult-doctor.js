const DOCTORS = [
  { name: 'Dr. Amara Okoye', specialty: 'Dermatologist — Scalp & Hair Loss', blurb: 'Specializes in scalp inflammation, dandruff, and pattern hair loss.' },
  { name: 'Dr. Priya Nair', specialty: 'Trichologist', blurb: 'Focuses on hair fiber health, breakage, and porosity-related damage.' },
  { name: 'Dr. Marcus Webb', specialty: 'Dermatologist — General', blurb: 'General scalp and skin concerns, including persistent itch and irritation.' },
  { name: 'Dr. Lena Fischer', specialty: 'Dermatologist — Pediatric & Adult', blurb: 'Sees both children and adults for scalp conditions and hair thinning.' },
];
